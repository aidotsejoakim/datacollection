...
class DatasetLoader():
    ...
    @staticmethod
    def LoadDatasetFromJSON(file_directory:str) -> dict:
...
class DatasetsGenerator():
    ...
    def __init__(self, dataset:DatasetLoader, labels:tuple, prompt_structure:dict, list_structure:dict, few_shot_range:tuple=(0,3), dataset_training_size:int = 10_000, dataset_other_size:int = 1_000):
